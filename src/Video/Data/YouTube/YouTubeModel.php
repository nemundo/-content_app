...
$this->start = new \Nemundo\Model\Type\Number\NumberType($this);
$this->start->tableName = "video_youtube";
$this->start->externalTableName = "video_youtube";
$this->start->fieldName = "start";
$this->start->aliasFieldName = "video_youtube_start";
$this->start->label = "Start";
$this->start->allowNullValue = true;
