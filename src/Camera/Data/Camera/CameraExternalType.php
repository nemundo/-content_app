...
$this->hasGeoCoordinate = new \Nemundo\Model\Type\Number\YesNoType();
$this->hasGeoCoordinate->fieldName = "has_geo_coordinate";
$this->hasGeoCoordinate->tableName = $this->parentFieldName . "_" . $this->externalTableName;
$this->hasGeoCoordinate->externalTableName = $this->externalTableName;
$this->hasGeoCoordinate->aliasFieldName = $this->hasGeoCoordinate->tableName . "_" . $this->hasGeoCoordinate->fieldName;
$this->hasGeoCoordinate->label = "Has Geo Coordinate";
$this->addType($this->hasGeoCoordinate);
