...
class ArticleExternalType extends \Nemundo\Model\Type\External\ExternalType {
/**
...
$this->externalModelClassName = ArticleModel::class;
$this->externalTableName = "feed_article";
