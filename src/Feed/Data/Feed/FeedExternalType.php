...
$this->feedImage = new \Nemundo\Model\Type\File\ImageType();
$this->feedImage->fieldName = "feed_image";
$this->feedImage->tableName = $this->parentFieldName . "_" . $this->externalTableName;
$this->feedImage->externalTableName = $this->externalTableName;
$this->feedImage->aliasFieldName = $this->feedImage->tableName . "_" . $this->feedImage->fieldName;
$this->feedImage->label = "Feed Image";
$this->addType($this->feedImage);
