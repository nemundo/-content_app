...
$this->feedImage = new \Nemundo\Model\Type\File\ImageType($this);
$this->feedImage->tableName = "feed_feed";
$this->feedImage->externalTableName = "feed_feed";
$this->feedImage->fieldName = "feed_image";
$this->feedImage->aliasFieldName = "feed_feed_feed_image";
$this->feedImage->label = "Feed Image";
$this->feedImage->allowNullValue = true;
